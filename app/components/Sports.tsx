...
const SPORTS_DATA = [
  {
    ...
    rules: [
      ...
      "Accomodation Student Coordinator ~ Mr. Sarthak Patil ~ +91 9028698848 | Ms. Tejaswini Kumbhar ~ +91 8861109939",
    ],
  ...
  },
  {
    ...
    rules: [
      ...
      "Charges - 1000/- per day per person.",
      "Details of the hotels nearby will be provided. (No transportation facility will be provided to these participants)",
      "Accomodation Student Coordinator ~ Mr. Sarthak Patil ~ +91 9028698848",
    ],
